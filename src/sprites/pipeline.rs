...
use bevy::{
    ...
    render::{
        ...
        view::{
            ExtractedView, Msaa, RenderVisibleEntities, RetainedViewEntity, ViewTarget,
...
use super::texture_slice::*;

pub(crate) struct SpritesPipelinePlugin;
impl Plugin for SpritesPipelinePlugin {
        ...
        RenderPipelineDescriptor {
            ...
            fragment: Some(FragmentState {
                ...
                targets: vec![Some(ColorTargetState {
                    format: TextureFormat::R16Uint, //format,
                    blend: None,                    // Some(BlendState::ALPHA_BLENDING),
